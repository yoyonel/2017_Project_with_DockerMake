...
QtModule {
    ...
    libFilePathDebug: ""
    libFilePathRelease: "/opt/qt57/lib/libQt5CLucene.so.5.7.1"
    cpp.defines: ["QT_CLUCENE_LIB"]
    cpp.includePaths: ["/opt/qt57/include", "/opt/qt57/include/QtCLucene", "/opt/qt57/include/QtCLucene/5.7.1", "/opt/qt57/include/QtCLucene/5.7.1/QtCLucene"]
